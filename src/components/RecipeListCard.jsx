  ...
  return (
    <div className='recipe-list-card mb-3 px-3 py-3 d-flex justify-content-between align-items-center'>
        ...
        <div className='recipe-options d-flex align-items-center'>
            <p className='mb-0 mx-2 recipe-option'><i className="fa-solid fa-pen-to-square me-1"></i> Edit</p>
            <p className='mb-0 mx-2 recipe-option'><i className="fa-solid fa-trash me-1"></i> Delete</p>
        </div>
    </div>
  )
}
